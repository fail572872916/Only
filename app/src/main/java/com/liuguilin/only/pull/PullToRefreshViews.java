package com.liuguilin.only.pull;
...
public class PullToRefreshViews extends ViewGroup {
    ...
    public PullToRefreshViews(Context context) {
        this(context, null);
    }

    public PullToRefreshViews(Context context, AttributeSet attrs) {
        super(context, attrs);
